...
Production export tables live under **`celpip-d8f02.analytics_celpip`** (dataset id from your GA4 BigQuery link). Bootstrap SQL: [`sql/bigquery/01_bootstrap_checks.sql`](sql/bigquery/01_bootstrap_checks.sql).
