...
export const PAGE_SEO_REGISTRY: Record<string, PageSeoItem> = {
  ...
  "/app": {
    path: "/app",
    title: "CELPIP Practice Test Mobile App | Android Download",
    description:
      "Download the CELPIP Practice Test Android app. Practice Listening, Reading, Writing, and Speaking on your phone with AI feedback.",
    keywords: ["celpip app", "celpip android", "celpip mobile practice"],
  },
  "/score-calculator": {
  ...
  "/league": {
    path: "/league",
    title: "CELPIP League: Weekly Challenges & Study Progress Tracker",
    description:
  ...
  "/auth": {
    path: "/auth",
    title: "Authentication | CELPIP Practice Test",
    description: "Authentication handler for CELPIP Practice Test.",
    indexability: "noindex",
  },
  "/auth/app-session": {
  ...
  "/cms/dashboard/league": {
    path: "/cms/dashboard/league",
    title: "League Admin",
    description: "Manage CELPIP league challenges and settings.",
    indexability: "noindex",
  },
