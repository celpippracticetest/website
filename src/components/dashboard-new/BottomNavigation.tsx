      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            initial={
              practice ? { scale: 0, opacity: 0 } : { scale: 1, opacity: 1 }
            }
            animate={{
              opacity: practice ? 1 : 0.6,
              scale: practice ? 1 : 0.95,
            }}
          ...
          >
            <div className="w-[24px] h-[24px]">
              {practice ? (
                <AnimatedIcon animationData={bookAnimation} isActive={true} />
              ) : (
                <SvgBook />
              )}
            </div>
        ...
        >
          ...
          <motion.div
            ...
            initial={
              mockTest ? { scale: 0, opacity: 0 } : { scale: 1, opacity: 1 }
            }
            animate={{
              opacity: mockTest ? 1 : 0.6,
              scale: mockTest ? 1 : 0.95,
            }}
            transition={{ type: "spring", stiffness: 300, damping: 25 }}
        ...
        >
          ...
          <motion.div
            ...
            initial={
              isLearning ? { scale: 0, opacity: 0 } : { scale: 1, opacity: 1 }
            }
            animate={{
              opacity: isLearning ? 1 : 0.6,
              scale: isLearning ? 1 : 0.95,
            }}
            transition={{ type: "spring", stiffness: 300, damping: 25 }}
            className="flex flex-col items-center gap-1 cursor-pointer"
          >
            <div className="w-[24px] h-[24px]">
              {isLearning ? (
                <AnimatedIcon animationData={checkAnimation} isActive={true} />
              ) : (
                <SvgCheck />
              )}
            </div>
        ...
        >
          ...
          <motion.div
            ...
            initial={
              isWords ? { scale: 0, opacity: 0 } : { scale: 1, opacity: 1 }
            }
