  ...
  (
    ...
    const resultsHref = examId
      ? (() => {
          ...
          return `${base}${base.includes("?") ? "&" : "?"}partNumber=part${partId}`;
        })()
      : "#";
        ...
        <div className="flex flex-col screen744:!flex-row flex-wrap  justify-between my-[24px] w-full h-auto min-h-[56px] gap-[20px]">
          <div className="flex gap-[10px]  screen744:!gap-[40px] items-center">
            ...
            <div className="flex gap-[10px]">
              ...
              <AskBeavoButton className="screen744:block hidden screen744:!right-6 screen744:!left-auto screen744:!translate-x-0 screen744:!fixed screen744:!bottom-6 screen1280:!left-1/2 screen1280:!right-auto screen1280:!-translate-x-1/2" />
            </div>
          </div>
          <div
