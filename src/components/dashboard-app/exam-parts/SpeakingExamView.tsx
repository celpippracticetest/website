    ...
    <div className="h-full mx-auto w-full  transition-all duration-300 flex gap-5">
      ...
      <div className="flex flex-col w-full">
        <div>
          ...
          <div className="flex  flex-col screen744:!flex-row  justify-between my-[24px] w-full h-auto min-h-[56px] gap-[20px]">
            <div className="flex gap-[40px] items-center">
              <span className="shrink-0">
                Exam {examName?.replace("Mock Set", "")}
              </span>
              <a
                className="rounded-[24px] flex-wrap px-[16px] shrink-0 text-[14px] font-normal border-[1px] bg-white flex items-center justify-center border-[#76808F] max-w-[186px] w-full h-[40px]"
