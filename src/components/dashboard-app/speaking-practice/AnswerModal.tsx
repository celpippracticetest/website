    ...
    <>
      {isAnswerModalOpen && (
        <div
          ...
          className="fixed inset-0 z-[99] bg-stone-300/80 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 transition-all duration-300"
        ></div>
      )}
      {isAnswerModalOpen && (
        <div
