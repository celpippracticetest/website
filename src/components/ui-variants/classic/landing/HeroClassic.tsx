...
import ExamSectionCardClassic from "./ExamSectionCardClassic";
...
const SvgMockExamLight = dynamic(() => import("@/components/icons/MockExamsLight"), {
  ssr: false,
});
const SvgSampleTest = dynamic(() => import("@/components/icons/SampleTest"), {
  ssr: false,
});
const SvgGuide = dynamic(() => import("@/components/icons/Guide"), { ssr: false });
const SvgScoring = dynamic(() => import("@/components/icons/Scoring"), { ssr: false });
const SvgPlus = dynamic(() => import("@/components/icons/Plus"), { ssr: false });
const SvgListening = dynamic(() => import("@/components/icons/Listening"), {
  ssr: false,
});
const SvgSpeaking = dynamic(() => import("@/components/icons/Speaking"), {
  ssr: false,
});
const SvgWriting = dynamic(() => import("@/components/icons/Writing"), { ssr: false });
const SvgReading = dynamic(() => import("@/components/icons/Reading"), { ssr: false });
const SvgMockExamsColorful = dynamic(
  () => import("@/components/icons/MockExamsColorful"),
  { ssr: false }
);
...
const HeroClassic = () => {
  ...
  return (
    ...
    ease-in-out transform bottom-0`}
      ...
      >
        <TopHeaderByVariant layout="hero" />
