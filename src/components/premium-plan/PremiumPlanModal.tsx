...
import { buildCheckoutSessionAction } from "@/lib/planCheckout";
...
const PremiumPlanModal = () => {
  ...
  const faqs = [
    ...
    {
      question:
        "How exact are CELPIP practice tests compared to the real test?",
      answer:
            ...
            <div className="overflow-y-auto flex-1 p-6 md:p-10 custom-scrollbar">
              <div className="max-w-5xl mx-auto w-full">
                ...
                <div className="mb-16 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
                  <h3 className="text-xl md:text-2xl font-semibold text-blue-950 text-center md:text-left max-w-[300px]">
                    Trusted by students from top universities
                  </h3>
                  <div className="flex flex-wrap justify-center md:justify-end gap-3 md:gap-4">
                    {[img1, img2, img3, img5, img6, img7, img8, img9].map(
                      (src, index) => (
                        <div
                          key={index}
