...
/**
 * Original homepage hero (home A/B style 3 / `?s=3` / `legacy` variant).
 * Matches layout from 233fb0e4fea1dcfb6559392594b91c9acfec7b38 (ExamSectionCard + section chrome).
 */
const HeroLegacy = ({ heroImage }: HeroLegacyProps) => {
  const { ref } = useInView();
            ...
            <div className="flex flex-col w-full screen744:!justify-between justify-center">
              ...
              <div className="flex screen744:!justify-start justify-center">
                <div onClick={() => handleCTAClick("hero_main")}>
                  <Button href={href} size="lg" className="mt-[24px]">
                    <SvgPlus />
                    <span>{label}</span>
                  </Button>
                </div>
