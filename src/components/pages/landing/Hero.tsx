            ...
            <div className="flex flex-col w-full screen744:!justify-between justify-center">
              <div className="items-center gap-[8px] screen1280:!mt-[35px] mt-[37px] flex flex-row screen744:!justify-start justify-center">
                ...
                <SvgMedalMd className="flex screen1280:!hidden" />
                  ...
                  <span className="text-primary2 font-extrabold">#1 Top rated</span> CELPIP Resource 2026{" "}
                </span>
              </div>
              <div className="mt-[21px] flex h-auto min-h-[76px] w-full flex-row justify-between screen744:!h-[135px] screen744:!min-h-0 screen1280:!mt-[38px] screen1280:!h-[245px] screen744:!justify-between justify-center">
                <h1 className="text-center font-bold text-[22px] leading-[28px] text-text1 screen744:!text-left screen744:!text-[30px] screen744:!leading-[38px] screen1280:!text-[65px] screen1280:!leading-[70px]">
              ...
              <div className="flex flex-col screen744:!justify-start justify-center items-center screen744:!items-start gap-[10px]">
                <Button
                  href="/practice-overview"
                  size="lg"
                  className="mt-[24px]"
                ...
                <p className="text-text2 text-[12px] screen744:!text-[14px] leading-snug max-w-[420px] text-center screen744:!text-left px-[8px] screen744:!px-0">
                  Free account: try practice across all four skills. Upgrade anytime for full mocks, the full bank, and unlimited AI feedback—no credit card to start.
                </p>
              </div>
