    ...
    >
      <div className="flex flex-col max-w-[1440px] w-full">
        <div className="flex flex-col screen744:!flex-row screen744:!gap-[180px] justify-center px-[24px]">
          ...
          <div className="mt-[40px] screen744:!mt-[85px] h-[126px] max-w-[236px] w-full self-center screen744:!self-start">
        ...
        <div className="flex mt-[48px] screen744:!mt-[80px] justify-center">
