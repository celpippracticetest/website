  ...
  return (
    <>
      <div className="flex flex-col ">
        <span className="text-[18px] font-semibold text-text1">
          Train Like It’s the Real CELPIP Exam
        </span>
        <span className="text-[12px] font-normal mt-[10px] mb-[7px]">
      ...
      <div className="text-text3   rounded-[8px] border-[1px] border-[#D5D6D8] min-h-[369px]">
        <div className="flex justify-between px-[16px] flex-col-reverse ">
          <h2 className="text-[12px] font-normal leading-[24px] pt-[8px] pb-[8px]">
            A Peaceful Countryside Road
          </h2>
          <div className="flex items-center gap-[16px] pt-[12px] sm:!py-[12px] justify-end">
        ...
        <div className="flex border-t-[1px] border-[#D5D6D8] flex-col ">
          <div className="flex-1 h-auto max-w-[530px] md:!border-r-[1px] border-[#D5D6D8] flex  p-[16px] flex-col">
            <span className="text-text2 text-[12px] font-normal leading-[24px]">
              A local business council is exploring ways to strengthen the
              economy by helping small businesses and wants your input after
              seeing their struggles and potential. They’ve sent a survey to
              find the best support method, aiming to lift the community’s
              prosperity. This is your chance to boost local growth! Which
              option do you prefer? Why? -Option A: Provide tax incentives and
              grants to small businesses. -Option B: Create community markets
              and pop-up events for local entrepreneurs.
            </span>
