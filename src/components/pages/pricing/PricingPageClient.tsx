...
export default function PricingPageClient({ plans }: PricingPageClientProps) {
  ...
  return (
    <Box className="overflow-y-auto flex-1 p-6 md:p-10">
      <Box className="max-w-5xl mx-auto w-full">
        ...
        <Box className="text-center mb-10">
          ...
          <Box className="flex items-center justify-center gap-2 text-gray-700 font-medium mb-8">
            <AvatarCarousel />
            <span>Trusted by 70k+ test-takers</span>
          </Box>

          {/* Features Bar */}
          <Box className="flex flex-wrap justify-center gap-4 md:gap-8 text-sm font-medium text-gray-700 mb-10">
        ...
        {/* Pricing Cards */}
        <Box className="flex flex-wrap justify-center gap-6 mb-16">
