...
import { CheckCircle2, AlertTriangle, FlaskConical, ArrowRight, FileText, BookOpen } from "lucide-react";
        ...
        <Box className="mb-20">
          ...
          <Box className="flex flex-col md:flex-row gap-6">
            <Card className="flex-1 hover:shadow-md transition-shadow border-t-4 border-t-cyan-500">
              <CardHeader>
                <Box className="w-12 h-12 rounded-lg bg-cyan-100 flex items-center justify-center mb-4 text-cyan-600"><FileText className="w-6 h-6" /></Box>
        ...
        <Box className="mb-20">
          ...
          <Card className="overflow-hidden border-0 shadow-lg">
            <Table>
              ...
              <TableBody>
                <TableRow className="hover:bg-slate-50/50"><TableCell className="font-medium pl-6 py-4"><Box className="flex items-center gap-3"><Box className="p-2 rounded bg-cyan-100 text-cyan-600"><CheckCircle2 className="w-4 h-4" /></Box>Writing and Speaking AI Feedback</Box></TableCell><TableCell className="py-4 text-slate-600">Instant scores and feedback.</TableCell></TableRow>
                <TableRow className="hover:bg-slate-50/50"><TableCell className="font-medium pl-6 py-4"><Box className="flex items-center gap-3"><Box className="p-2 rounded bg-cyan-100 text-cyan-600"><CheckCircle2 className="w-4 h-4" /></Box>60 Full-Length Mock Exams</Box></TableCell><TableCell className="py-4 text-slate-600">Practice in exam conditions.</TableCell></TableRow>
                <TableRow className="hover:bg-slate-50/50"><TableCell className="font-medium pl-6 py-4"><Box className="flex items-center gap-3"><Box className="p-2 rounded bg-cyan-100 text-cyan-600"><CheckCircle2 className="w-4 h-4" /></Box>Task-Specific Practice</Box></TableCell><TableCell className="py-4 text-slate-600">Focus on weaker sections.</TableCell></TableRow>
                <TableRow className="hover:bg-slate-50/50"><TableCell className="font-medium pl-6 py-4"><Box className="flex items-center gap-3"><Box className="p-2 rounded bg-cyan-100 text-cyan-600"><CheckCircle2 className="w-4 h-4" /></Box>Study on Your Schedule</Box></TableCell><TableCell className="py-4 text-slate-600">Access from any device.</TableCell></TableRow>
              </TableBody>
            </Table>
          </Card>
        </Box>
