...
const READING_TASK_OPTIONS = [
  { id: "67f454ba16846d97ecbde9f0", name: "Task #1: Giving Advice" },
  {
    id: "67f454d316846d97ecbde9f1",
    name: "Task #2: Talking about personal experience",
  },
  { id: "67f454ef16846d97ecbde9f2", name: "Task #3: Describing a Scene" },
  { id: "67f4550216846d97ecbde9f3", name: "Task #4: Making predictions" },
  { id: "67f4551416846d97ecbde9f4", name: "Task #5: Comparing and Persuading" },
  {
    id: "67f4552d16846d97ecbde9f5",
    name: "Task #6: Dealing with a difficult situation",
  },
  { id: "67f4553d16846d97ecbde9f6", name: "Task #7: Expressing opinions" },
  {
    id: "67f4555616846d97ecbde9f7",
...
export default function SpeakingPracticeInputForm() {
  ...
  async function uploadFile(file: File): Promise<string | null> {
    ...
    const upload = new Upload({
      ...
      params: {
        ...
        Key: `practices/speaking/${Date.now()}_${file.name}`, // Unique key for the file
        Body: file,
      },
    });
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      const result = await saveSpeakingPractice(formData, selectedPracticeId);
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Fill in the form below to create a new speaking practice exercise.
        </p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Select the type of speaking task
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <div className="flex justify-end">
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? "Processing..." : "Create Speaking Practice"}
            </Button>
          </div>
        </form>
      </Form>
