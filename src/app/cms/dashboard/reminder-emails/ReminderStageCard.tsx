...
import { sampleReminderMergeFields } from "@/lib/reminder-email/merge-fields";
...
type Props = {
  ...
  onEdit: () => void;
  onDoneEditing: () => void;
  onUpdate: (updates: Partial<ReminderEmailStage>) => void;
  onDelete: () => void;
  onMove: (direction: "up" | "down") => void;
  onTestSend: () => void;
};

export function ReminderStageCard({
  stage,
  index,
  total,
  isEditing,
  ...
  const previewMergeFields = sampleReminderMergeFields();
