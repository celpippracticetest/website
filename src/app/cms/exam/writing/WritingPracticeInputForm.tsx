...
export default function WritingPracticeInputForm() {
  ...
  async function uploadFile(file: File): Promise<string | null> {
    ...
    const upload = new Upload({
      ...
      params: {
        ...
        Key: `exams/writing/${Date.now()}_${file.name}`, // Unique key for the file
        Body: file,
      },
    });
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      const result = await saveWritingPractice(formData, selectedExamId);
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-2xl font-bold">Create Writing Exam</h1>
        <p className="text-muted-foreground">
          Fill in the form below to create a new writing exam.
        </p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              {/* <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Select the type of writing task</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              /> */}
            ...
            {/* <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe this writing practice" className="min-h-[100px]" {...field} />
                  </FormControl>
          ...
          <div className="flex justify-end">
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? "Processing..." : "Create Writing Exam"}
            </Button>
          </div>
        </form>
      </Form>
