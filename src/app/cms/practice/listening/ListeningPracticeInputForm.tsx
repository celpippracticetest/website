...
const LISTENING_TASK_OPTIONS = [
  { id: "67ebefda187829d27daac3c4", name: "Listening to Problem solving" },
  {
    id: "67ebefe2187829d27daac3c5",
    name: "Listening to a daily life conversation",
  },
  { id: "67ebefe7187829d27daac3c6", name: "Listening to information" },
  { id: "67ebefec187829d27daac3c7", name: "Listening to news item" },
  { id: "67ebeffe187829d27daac3c8", name: "Listening to discussion" },
  { id: "67ebf003187829d27daac3c9", name: "Listening to view port" },
];
...
export default function ListeningPracticeInputForm() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      taskId: LISTENING_TASK_OPTIONS[0].id,
      instructions: [],
      passages: [
        {
          id: "1",
  ...
  const simulateFileUpload = (uploadId: string) => {
  ...
  async function uploadFile(file: File): Promise<string | null> {
    ...
    const upload = new Upload({
      ...
      params: {
        ...
        Key: `practices/${Date.now()}_${file.name}`, // Unique key for the file
        Body: file,
      },
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      const result = await saveListeningPractice(formData, selectedPracticeId);
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Fill in the form below to create a new listening practice exercise.
        </p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        {LISTENING_TASK_OPTIONS.map((option) => (
                    ...
                    <FormDescription>
                      Select the type of listening task
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Expected completion time (e.g., 1:30)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    A brief description of what the practice contains
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="flex justify-end">
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? "Processing..." : "Create Listening Practice"}
            </Button>
          </div>
        </form>
      </Form>
