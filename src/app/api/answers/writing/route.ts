        ...
        tools: [
          {
            ...
            function: {
              ...
              description: "evaluating and providing feedback on a writing sample and content analysis scores",
              parameters: {
                type: "object",
                properties: {
                  overall: {
                    type: "number",
                    description: "You are an experienced CELPIP Examiner. Read the whole user response carefully and provide an Overall Score out of 12. If there is only one minor vocabulary or grammatical mistake, the score should reflect exactly one point deduction (score = 11). Multiple mistakes should be accurately reflected in the overall score.",
                  },
                  feedback: {
                    type: "string",
                  ...
                  taskFulfillment: {
                    type: "number",
                    description: "Evaluate the user's response for Task Fulfillment, providing an accurate and fair score out of 12.",
                  },
                  contentAndCoherence: {
                    type: "number",
                    description: "Evaluate the user's response for Content & Coherence, assigning an accurate and fair score out of 12.",
                  },
                  readabilityAndGrammar: {
                    type: "number",
                    description: "Evaluate the user's response for Readability & Grammar, assigning an accurate and fair score out of 12. One grammatical mistake equals a one-point deduction.",
                  },
                },
                required: [
                  "overall",
